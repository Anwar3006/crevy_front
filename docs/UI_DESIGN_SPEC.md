...
### 6.1 Project Owners List — `/project-owners`
...
### 6.2 Project Owner Detail — `/project-owners/[userId]`
...
### 6.3 Register / Onboard Project Owner — `/project-owners/register`
...
├── /project-owners               Project owners list               ✅ DONE
├── /project-owners/register      Onboard project owner             🔧 PARTIAL
├── /project-owners/[userId]      Project owner detail              ✅ DONE
...
*UI Design Specification prepared: May 2026 · Crevy Platform · Foovante Global*
*Hand this document to the design team alongside the brand guidelines and Figma component library starter.*
