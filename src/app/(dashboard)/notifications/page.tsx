    ...
    <div className="max-w-4xl mx-auto py-12 px-6 space-y-12 animate-in fade-in duration-700">
      ...
      <div className="space-y-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <button
                ...
                className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                  filter === t.toLowerCase()
                    ...
                    : "bg-white border border-border text-muted-foreground hover:border-slate-900 hover:text-foreground"
                }`}
              >
                {t}
              </button>
          ...
          <Button
            variant="ghost"
            className="text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-emerald-600"
          >
            Mark all as read
          </Button>
        </div>
            ...
            >
              ...
              <div className="flex-1 space-y-2">
                <div className="flex justify-between items-start">
                  <h3
                    className={`font-black uppercase tracking-tight text-lg ${n.read ? "text-slate-700" : "text-foreground"}`}
                  >
                    {n.title}
                  </h3>
                  {!n.read && (
        ...
        <div className="pt-12 text-center border-t border-border italic">
