  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      ...
      <div className="grid gap-8">
        {/* MFA Status */}
        <div className="p-8 border border-border bg-white flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="border border-border bg-white">
          ...
          <div className="divide-y divide-slate-100">
            <div className="flex justify-between items-center p-6 hover:bg-muted transition-colors">
              <div>
                <div className="font-sans text-sm font-bold text-foreground mb-1">
            ...
            <div className="flex justify-between items-center p-6 hover:bg-muted transition-colors group">
              <div>
                <div className="font-sans text-sm font-bold text-foreground mb-1">
                  iOS / Safari Mobile
                </div>
              ...
              <button
                type="button"
                className="p-2 border border-border text-muted-foreground hover:text-red-600 hover:border-red-600 transition-colors opacity-0 group-hover:opacity-100"
              >
                <X size={14} />
              </button>
            </div>
