...
export default function ProjectHero({ project, visual }: ProjectDetailProps) {
  return (
    <div className="relative flex min-h-[90vh] flex-col justify-end overflow-hidden bg-slate-950 group border-b border-slate-900">
      {/* ── Background Layer ── */}
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-end gap-16 p-8 lg:grid-cols-2 lg:p-20">
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div className="flex flex-wrap items-center gap-3">
            <span className="border border-slate-700 bg-slate-900/80 px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-brand backdrop-blur-md rounded-none">
              {project.projectType?.replace("_", " ")}
            </span>
            <span className="border border-slate-800 bg-slate-950/80 px-4 py-1.5 text-[10px] font-mono font-bold uppercase tracking-[0.2em] text-slate-300 backdrop-blur-md rounded-none">
              Registry: VERRA
            </span>
          </div>
        ...
        <div className="animate-in fade-in slide-in-from-right-10 duration-1000 delay-300">
          <div className="relative space-y-8 overflow-hidden border border-slate-800 bg-slate-900/90 p-10 shadow-2xl backdrop-blur-xl group/card rounded-none">
            ...
            <div className="grid grid-cols-2 gap-4 relative z-10">
              <div className="border border-slate-800 bg-slate-950 p-4 rounded-none">
            ...
            <Link
              ...
              className="flex h-16 w-full items-center justify-center gap-3 bg-brand font-bold uppercase tracking-[0.2em] text-slate-900 text-xs shadow-xl transition-colors hover:bg-white rounded-none group/btn relative z-10"
            >
            ...
            <p className="flex items-center justify-center gap-2 text-center text-[9px] font-mono uppercase tracking-widest text-slate-400 relative z-10">
